...
allprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("me.ahoo.cosid:cosid-bom:2.10.2")
            mavenBom("org.mockito:mockito-bom:5.14.2")
            mavenBom("io.netty:netty-bom:4.1.116.Final")
        ...
        dependencies {
            ...
            // spring mcp
            dependency("org.springframework.experimental:mcp:0.5.0")
            dependency("org.springframework.experimental:spring-ai-mcp:0.5.0")
            // mapstruct & lombok
